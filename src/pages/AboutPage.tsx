    ...
    <div className="flex-1 flex flex-col">
      <WaterfallBand photos={photos} onSelect={setSelected} height="46vh" defer>
        <div className="w-full max-w-[1080px]">
          ...
          <h1 className="page-heading font-emphasis-bold">{content.about.title}</h1>
      ...
      <div className="px-4 md:px-10 pt-10 md:pt-14 pb-12 w-full max-w-[820px] mx-auto">
        <blockquote className="border-l-[6px] border-[var(--primary)] pl-8 pr-4 py-4 italic font-emphasis-bold text-2xl sm:text-3xl leading-snug mb-8">
          {content.about.quote}
        </blockquote>
        ...
        {content.about.sections.map((section, index) => (
          <Card key={section.heading} innerClassName="!p-8 mb-4" delay={0.08 * index}>
            <div className="font-emphasis-bold text-7xl leading-none tracking-tighter text-[var(--primary)]">
              {String(index + 1).padStart(2, "0")}
            </div>
            <h2 className="font-emphasis-bold text-2xl uppercase tracking-tight mt-3 mb-2">
              {section.heading}
            </h2>
